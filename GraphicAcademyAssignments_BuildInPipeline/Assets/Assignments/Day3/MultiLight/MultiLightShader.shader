    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata v) 
            {
                ...
                o.lightColorNotImportent = 0;
                    ...
                    #endif
                    // それ以上のライトは球面調和ライトになる
                    o.lightColorNotImportent += max(0, ShadeSH9(float4(o.normalW, 1)));
                #endif
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                half3 viewDir = normalize(UnityWorldSpaceViewDir(i.posW.xyz));
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // 光の減衰
                #ifdef POINT
                    float3 lightCoord = mul(unity_WorldToLight, i.posW).xyz;
                    fixed atten = tex2D(_LightTexture0, dot(lightCoord, lightCoord).rr).UNITY_ATTEN_CHANNEL;
                #elif SPOT
                    float4 lightCoord = mul(unity_WorldToLight, i.posW);
